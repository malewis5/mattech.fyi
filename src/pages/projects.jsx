...
const projects = [
  {
    ...
    logo: logoPlanetaria,
    stack:
      'React, Nextjs, Headless CMS, Serverless Functions, Stripe, AWS, MongoDB, Kubernetes, Cloud Native',
  },
  {
    ...
    logo: logoCosmos,
    stack: 'Nextjs, React, Vercel, Prisma, Typescript, tRPC, Postgres, AWS',
  },
  {
    name: 'OPSIQ',
    description:
    ...
    logo: logoOpsiq,
    stack: 'React, Twilio, Node.js, Express, AWS',
  },
  {
    ...
    logo: logoLucid,
    stack: 'React, Firebase, iOS, Swift, Headless CMS',
  },
  {
    name: 'Realtor.com',
    description:
    ...
    stack: 'SwiftUI, iOS, Android, Flutter,',
    link: { href: 'https://realtor.com', label: 'realtor.com' },
    logo: logoRealtor,
  },
  {
    name: 'The Industry App',
    description:
      'Still under development - Focused on the Modeling and Acting industry in Manhattan and Los Angeles.',
    stack: [
      'React Native, Postgres, Supabase, Serverless Functions, Stripe, AWS',
    ],
